...
data <- ""
p <- ""
data<-read.table("culture_genic_distances.heatmap.txt", header=TRUE, sep="\t")
...
ggsave(filename = ("culture_heat_maps_actual_result001.png"), plot = last_plot(), scale = 1, width = 7, height = 7, dpi = 1200, limitsize = TRUE)

ggsave(filename = ("culture_heat_maps_actual_result001.eps"), plot = last_plot(), scale = 1, width = 7, height = 7, dpi = 1200, limitsize = TRUE)
...
ggsave(filename = ("culture_heat_maps_actual_result001_colours.pdf"), plot = last_plot(), scale = 1, width = 7, height = 7, dpi = 1200, limitsize = TRUE)

ggsave(filename = ("culture_heat_maps_actual_result001_colours.eps"), plot = last_plot(), scale = 1, width = 7, height = 7, dpi = 1200, limitsize = TRUE)
...
#ggsave(filename = ("culture_heat_maps_actual_result003a.png"), plot = last_plot(), scale = 1, width = 7, height = 7, dpi = 1200, limitsize = TRUE)
...
ggsave(filename = ("culture_heat_maps_facet001.png"), plot = last_plot(), scale = 1, width = 7, height = 7, dpi = 1200, limitsize = TRUE)


ggsave(filename = ("culture_heat_maps_facet.eps"), plot = last_plot(), scale = 1, width = 7, height = 7, dpi = 1200, limitsize = TRUE)
...
ggsave(filename = ("culture_heat_maps_real001a_colours_wild.png"), plot = last_plot(), scale = 1, width = 7, height = 7, dpi = 1200, limitsize = TRUE)

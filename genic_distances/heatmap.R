...
data<-read.table("sk048_genic_distances.heatmap.txt", header=TRUE)
...
p + geom_bin2d (bins = 40)+ scale_fill_gradient (low="blue", high = "red")+(geom_point(aes(colour=factor(Class), shape=factor(Class))))
...
ggsave(filename = ("sk048_heat_maps_actual_result001.eps"), plot = last_plot(), scale = 1, width = 7, height = 7, dpi = 1200, limitsize = TRUE)
 ...
 p + geom_bin2d (bins = 40)+ scale_fill_gradient (low="blue", high = "red")+(geom_point(aes(colour=factor(Class), shape=factor(Class)))) + scale_colour_manual(values = c("green","yellow", "black", "purple"))
...
p + geom_bin2d (bins = 40)+ scale_fill_gradient (low="blue", high = "red") + geom_point(aes(colour=factor(Class))) +facet_grid(.~Class)
...
p + geom_bin2d (bins = 40)+ scale_fill_gradient (low="blue", high = "red") +facet_grid(.~Class)
...
p + geom_bin2d (bins = 80)+ scale_fill_gradient (low="blue", high = "red")+(geom_point(aes(colour=factor(Class), 
shape=factor(Class)))) + scale_colour_manual(values = c("yellow"))
...
ggsave(filename = ("sk048_heat_maps_real001a_colours_wild.png"), plot = last_plot(), scale = 1, width = 7, height = 7, dpi = 1200, limitsize = TRUE)
 ...
 p + geom_bin2d (bins = 40)+ scale_fill_gradient (low="blue", high = "red")+(geom_point(aes(colour=factor(Class), shape=factor(Class)))) + scale_colour_manual(values = c("yellow"))




 p + geom_bin2d (bins = 40)+ scale_fill_gradient (low="blue", high = "red")+(geom_point(aes(colour=factor(Class), shape=factor(Class)))) + scale_colour_manual(values = c("green","yellow", "black"))
...
p + geom_bin2d (bins = 40)+ scale_fill_gradient (low="blue", high = "red")
...
p + geom_bin2d (bins = 40)+ scale_fill_gradient (low="blue", high = "red", limits = c(0, 2000))
...
p + geom_bin2d (bins = 40)+ scale_fill_gradient (low="blue", high = "red")+(geom_point(aes(colour=factor(Class) + geom_point(colour="grey90", size = 4, show_guide = TRUE), shape=factor(Class)))) 
...
p + geom_bin2d (bins = 80)+ scale_fill_gradient (low="blue", high = "red")+(geom_point(aes(colour=factor(Class), shape=factor(Class)))) + scale_colour_manual(values = c("yellow"))

...
def plot_seq_len_histograms(busco, SICAVARII, outname, prime):
    ...
    # graph1
    data = [numpy.log10(SICAVARII), numpy.log10(busco)]
    rects1 = ax1.boxplot(data)
    ax1.set_xlabel('SICAVARII and BUSCO')
    ax1.set_ylabel('LOG10 Distances in Nucleotides')
    ax1.grid(True)
    ax1.set_title("%s SICAVARII and BUSCO %s_prime Genic Distances" % (outname, prime))
    fig.tight_layout()
    fig
...
##    # graph1
##    rects1 = ax1.boxplot(numpy.log10(SICAVARII))
##    ax1.set_xlabel('SICAVARII')
##    ax1.set_ylabel('Count')
##    ax1.grid(True)
##    ax1.set_title("%s SICAVARII %s_prime Genic Distances" % (outname, prime))
##    # graph 2
...
def seq_getter(filename1):
    ...
    SICAVARII = set("""PKA1H1_STAND_010023600
...
PKCLINC048_140023600""".split())
    ...
    for i in location_data:
        ...
        if gene_name in SICAVARII:
            try:
                prime = int(i[1].rstrip())
                SICAVARII_5prime.append(prime)
            except:
                pass
            try:
                prime = int(i[2].rstrip())
                SICAVARII_3prime.append(prime)
            except:
                pass
        if gene_name  in busco:
            ...
            try:
                ...
                pass
    return SICAVARII_5prime, SICAVARII_3prime, busco_3prime, busco_5prime


####################
#
##print("LOOKING AT: sks047 3 prime\n")
##SICAVARII_5prime, SICAVARII_3prime, busco_3prime, busco_5prime = seq_getter('sk047_genic_distances.heatmap.txt')
##
##plot_seq_len_histograms(busco_3prime, SICAVARII_3prime, "sk047_", "3")
##
##print("\nwe have %d BUSCO\n" % len(busco_3prime))
##average_standard_dev(busco_3prime)
##print("\nwe have %d 3 prime SICAVARII\n" % len(SICAVARII_3prime))
##average_standard_dev(SICAVARII_3prime)
##
##
##outdata = stats_on_list_of_sizes(SICAVARII_3prime, busco_3prime)
##
##print("\nlooking at sks047: 5 prime")
##print("we have %d 5 prime BUSCO\n" % len(busco_5prime))
##average_standard_dev(busco_5prime)
##
##print("we have %d 5 prime SICAVARII\n" % len(SICAVARII_5prime))
##average_standard_dev(SICAVARII_5prime)
##plot_seq_len_histograms(busco_5prime, SICAVARII_5prime, "sk047_", "5")
##
##
##
##outdata = stats_on_list_of_sizes(SICAVARII_5prime, busco_5prime)

############################################################
##print("\nLOOKING AT: sk048: 3 prime\n")
##SICAVARII_5prime, SICAVARII_3prime, busco_3prime, busco_5prime = seq_getter('sk048_genic_distances.heatmap.txt')
##print("we have %d BUSCO\n" % len(busco_3prime))
##average_standard_dev(busco_3prime)
##plot_seq_len_histograms(busco_3prime, SICAVARII_3prime, "sk048", "3")
##
##
##
##print("we have %d 3 prime SICAVARII\n" % len(SICAVARII_3prime))
##average_standard_dev(SICAVARII_3prime)
##
##
##
...
##print("we have %d 5 prime SICAVARII\n" % len(SICAVARII_5prime))
##average_standard_dev(SICAVARII_5prime)
##plot_seq_len_histograms(busco_5prime, SICAVARII_5prime, "sk048", "5")
##
##
##
##
...
SICAVARII_5prime, SICAVARII_3prime, busco_3prime, busco_5prime = seq_getter('culture_genic_distances.heatmap.txt')
print("we have %d BUSCO\n" % len(busco_3prime))
average_standard_dev(busco_3prime)
plot_seq_len_histograms(busco_3prime, SICAVARII_3prime, "culture", "3")
...
print("we have %d 5 prime SICAVARII\n" % len(SICAVARII_5prime))
average_standard_dev(SICAVARII_5prime)
plot_seq_len_histograms(busco_5prime, SICAVARII_5prime, "culture", "5")
...
SICAVARII_5prime, SICAVARII_3prime, busco_3prime, busco_5prime = seq_getter('ref_genic_distances.heatmap.txt')
print("we have %d BUSCO\n" % len(busco_3prime))
average_standard_dev(busco_3prime)
print("we have %d 3 prime SICAVARII\n" % len(SICAVARII_3prime))
print("SICAVARII_3prime", SICAVARII_3prime)
average_standard_dev(SICAVARII_3prime)
plot_seq_len_histograms(busco_3prime, SICAVARII_3prime, "Reference", "3")
...
print("we have %d 5 prime SICAVARII\n" % len(SICAVARII_5prime))
average_standard_dev(SICAVARII_5prime)
plot_seq_len_histograms(busco_5prime, SICAVARII_5prime, "Reference", "5")
